...
var RBY = {
    Abra: { types: ["Psychic"], bs: { hp: 25, at: 20, df: 15, sp: 90, sl: 105 }, weightkg: 50, nfe: true },
    Aerodactyl: { types: ["Rock", "Flying"], bs: { hp: 80, at: 100, df: 65, sp: 130, sl: 60 }, weightkg: 50 },
    Alakazam: { types: ["Psychic"], bs: { hp: 60, at: 50, df: 45, sp: 120, sl: 135 }, weightkg: 50 },
    Annihilape: { types: ["Ghost", "Fighting"], bs: { hp: 85, at: 125, df: 70, sp: 80, sl: 100 }, weightkg: 50 },
    Arbok: { types: ["Poison"], bs: { hp: 80, at: 95, df: 80, sp: 80, sl: 85 }, weightkg: 50 },
    Arcanine: { types: ["Fire", "Rock"], bs: { hp: 90, at: 95, df: 80, sp: 95, sl: 90 }, weightkg: 50 },
    Articuno: { types: ["Ice", "Flying"], bs: { hp: 90, at: 85, df: 100, sp: 95, sl: 130 }, weightkg: 50 },
    Beedrill: { types: ["Bug", "Poison"], bs: { hp: 70, at: 99, df: 40, sp: 121, sl: 55 }, weightkg: 50 },
    Bellossom: { types: ["Grass", "Fairy"], bs: { hp: 90, at: 65, df: 100, sp: 50, sl: 125 }, weightkg: 50 },
    Bellsprout: { types: ["Grass", "Poison"], bs: { hp: 50, at: 75, df: 35, sp: 40, sl: 65 }, weightkg: 50, nfe: true },
    Blastoise: { types: ["Water", "Steel"], bs: { hp: 90, at: 80, df: 105, sp: 75, sl: 90 }, weightkg: 50 },
    Blissey: { types: ["Normal"], bs: { hp: 250, at: 10, df: 20, sp: 50, sl: 120 }, weightkg: 50 },
    Bulbasaur: { types: ["Grass"], bs: { hp: 45, at: 49, df: 49, sp: 45, sl: 65 }, weightkg: 50, nfe: true },
    Butterfree: { types: ["Bug", "Psychic"], bs: { hp: 75, at: 50, df: 70, sp: 96, sl: 99 }, weightkg: 50 },
    Caterpie: { types: ["Bug"], bs: { hp: 45, at: 35, df: 35, sp: 45, sl: 20 }, weightkg: 50, nfe: true },
    Chansey: { types: ["Normal"], bs: { hp: 250, at: 5, df: 10, sp: 60, sl: 90 }, weightkg: 50, nfe: true },
    Charizard: { types: ["Fire", "Flying"], bs: { hp: 80, at: 85, df: 75, sp: 100, sl: 100 }, weightkg: 50 },
    Charmander: { types: ["Fire"], bs: { hp: 39, at: 50, df: 43, sp: 65, sl: 56 }, weightkg: 50, nfe: true },
    Charmeleon: { types: ["Fire"], bs: { hp: 58, at: 64, df: 58, sp: 80, sl: 75 }, weightkg: 50, nfe: true },
    Clefable: { types: ["Fairy", "Normal"], bs: { hp: 95, at: 80, df: 95, sp: 60, sl: 95 }, weightkg: 50 },
    Clefairy: { types: ["Fairy", "Normal"], bs: { hp: 75, at: 60, df: 50, sp: 40, sl: 75 }, weightkg: 50, nfe: true },
    Cloyster: { types: ["Rock", "Ice"], bs: { hp: 60, at: 90, df: 150, sp: 70, sl: 90 }, weightkg: 50 },
    Crobat: { types: ["Poison", "Flying"], bs: { hp: 75, at: 100, df: 65, sp: 130, sl: 80 }, weightkg: 50 },
    Cubone: { types: ["Ground"], bs: { hp: 50, at: 90, df: 85, sp: 35, sl: 40 }, weightkg: 50, nfe: true },
    Dewgong: { types: ["Water", "Ice"], bs: { hp: 95, at: 65, df: 85, sp: 75, sl: 100 }, weightkg: 50 },
    Diglett: { types: ["Ground"], bs: { hp: 20, at: 65, df: 25, sp: 95, sl: 45 }, weightkg: 50, nfe: true },
    Ditto: { types: ["Normal", "Ghost"], bs: { hp: 128, at: 68, df: 68, sp: 148, sl: 68 }, weightkg: 50 },
    Dodrio: { types: ["Normal", "Flying"], bs: { hp: 65, at: 110, df: 70, sp: 115, sl: 60 }, weightkg: 50 },
    Doduo: { types: ["Normal", "Flying"], bs: { hp: 35, at: 85, df: 45, sp: 75, sl: 35 }, weightkg: 50, nfe: true },
    Dragonair: { types: ["Dragon"], bs: { hp: 65, at: 95, df: 70, sp: 80, sl: 90 }, weightkg: 50, nfe: true },
    Dragonite: { types: ["Dragon", "Flying"], bs: { hp: 90, at: 130, df: 90, sp: 80, sl: 110 }, weightkg: 50 },
    Dratini: { types: ["Dragon"], bs: { hp: 45, at: 65, df: 40, sp: 50, sl: 55 }, weightkg: 50, nfe: true },
    Drowzee: { types: ["Psychic", "Ghost"], bs: { hp: 60, at: 40, df: 50, sp: 40, sl: 95 }, weightkg: 50, nfe: true },
    Dugtrio: { types: ["Ground"], bs: { hp: 40, at: 125, df: 50, sp: 122, sl: 65 }, weightkg: 50 },
    Eevee: { types: ["Normal"], bs: { hp: 65, at: 60, df: 60, sp: 65, sl: 100 }, weightkg: 50, nfe: true },
    Ekans: { types: ["Poison"], bs: { hp: 45, at: 60, df: 45, sp: 50, sl: 45 }, weightkg: 50, nfe: true },
    Electabuzz: { types: ["Electric", "Fighting"], bs: { hp: 65, at: 90, df: 54, sp: 106, sl: 100 }, weightkg: 50, nfe: true },
    Electivire: { types: ["Electric", "Fighting"], bs: { hp: 75, at: 100, df: 64, sp: 96, sl: 110 }, weightkg: 50 },
    Electrode: { types: ["Electric", "Normal"], bs: { hp: 60, at: 70, df: 60, sp: 135, sl: 95 }, weightkg: 50 },
    Espeon: { types: ["Psychic"], bs: { hp: 70, at: 65, df: 60, sp: 110, sl: 130 }, weightkg: 50 },
    Exeggcute: { types: ["Grass", "Psychic"], bs: { hp: 60, at: 40, df: 80, sp: 40, sl: 60 }, weightkg: 50, nfe: true },
    Exeggutor: { types: ["Grass", "Psychic"], bs: { hp: 90, at: 80, df: 95, sp: 55, sl: 120 }, weightkg: 50 },
    'Farfetch\u2019d': { types: ["Normal", "Flying"], bs: { hp: 70, at: 95, df: 65, sp: 102, sl: 88 }, weightkg: 50, nfe: true },
    Fearow: { types: ["Flying", "Dark"], bs: { hp: 80, at: 100, df: 70, sp: 100, sl: 60 }, weightkg: 50 },
    Flareon: { types: ["Fire"], bs: { hp: 65, at: 110, df: 60, sp: 70, sl: 130 }, weightkg: 50 },
    Gastly: { types: ["Ghost"], bs: { hp: 30, at: 35, df: 30, sp: 80, sl: 100 }, weightkg: 50, nfe: true },
    Gengar: { types: ["Ghost"], bs: { hp: 55, at: 65, df: 55, sp: 120, sl: 130 }, weightkg: 50 },
    Geodude: { types: ["Rock"], bs: { hp: 40, at: 80, df: 100, sp: 20, sl: 30 }, weightkg: 50, nfe: true },
    Glaceon: { types: ["Ice"], bs: { hp: 65, at: 60, df: 110, sp: 70, sl: 130 }, weightkg: 50 },
    Gloom: { types: ["Grass", "Poison"], bs: { hp: 65, at: 65, df: 75, sp: 40, sl: 95 }, weightkg: 50, nfe: true },
    Golbat: { types: ["Poison", "Flying"], bs: { hp: 70, at: 95, df: 60, sp: 105, sl: 75 }, weightkg: 50, nfe: true },
    Goldeen: { types: ["Water", "Normal"], bs: { hp: 45, at: 67, df: 60, sp: 63, sl: 50 }, weightkg: 50, nfe: true },
    Golduck: { types: ["Water", "Ghost"], bs: { hp: 80, at: 70, df: 77, sp: 88, sl: 105 }, weightkg: 50 },
    Golem: { types: ["Rock"], bs: { hp: 80, at: 120, df: 140, sp: 45, sl: 55 }, weightkg: 50 },
    Gorochu: { types: ["Electric", "Dark"], bs: { hp: 70, at: 100, df: 65, sp: 105, sl: 110 }, weightkg: 50 },
    Graveler: { types: ["Rock"], bs: { hp: 55, at: 95, df: 115, sp: 35, sl: 45 }, weightkg: 50, nfe: true },
    Grimer: { types: ["Poison", "Dark"], bs: { hp: 80, at: 80, df: 50, sp: 25, sl: 40 }, weightkg: 50, nfe: true },
    Growlithe: { types: ["Fire", "Rock"], bs: { hp: 55, at: 60, df: 45, sp: 60, sl: 60 }, weightkg: 50, nfe: true },
    Gyarados: { types: ["Water", "Flying"], bs: { hp: 95, at: 95, df: 79, sp: 81, sl: 120 }, weightkg: 50 },
    Haunter: { types: ["Ghost"], bs: { hp: 45, at: 50, df: 45, sp: 95, sl: 235 }, weightkg: 50, nfe: true },
    Hitmonchan: { types: ["Fighting", "Dark"], bs: { hp: 50, at: 95, df: 80, sp: 75, sl: 110 }, weightkg: 50 },
    Hitmonlee: { types: ["Fighting", "Normal"], bs: { hp: 50, at: 130, df: 67, sp: 122, sl: 41 }, weightkg: 50 },
    Hitmontop: { types: ["Fighting", "Ground"], bs: { hp: 50, at: 110, df: 100, sp: 100, sl: 50 }, weightkg: 50 },
    Horsea: { types: ["Water"], bs: { hp: 45, at: 35, df: 65, sp: 60, sl: 75 }, weightkg: 50, nfe: true },
    Hypno: { types: ["Psychic", "Ghost"], bs: { hp: 85, at: 60, df: 80, sp: 65, sl: 120 }, weightkg: 50 },
    Ivysaur: { types: ["Grass"], bs: { hp: 67, at: 62, df: 66, sp: 60, sl: 80 }, weightkg: 50, nfe: true },
    Jigglypuff: { types: ["Fairy", "Psychic"], bs: { hp: 110, at: 45, df: 35, sp: 20, sl: 60 }, weightkg: 50, nfe: true },
    Jolteon: { types: ["Electric"], bs: { hp: 65, at: 70, df: 60, sp: 130, sl: 110 }, weightkg: 50 },
    Jynx: { types: ["Ice", "Ghost"], bs: { hp: 55, at: 60, df: 55, sp: 115, sl: 125 }, weightkg: 50 },
    Kabuto: { types: ["Bug", "Rock"], bs: { hp: 30, at: 80, df: 90, sp: 55, sl: 45 }, weightkg: 50, nfe: true },
    Kabutops: { types: ["Steel", "Rock"], bs: { hp: 60, at: 125, df: 95, sp: 90, sl: 60 }, weightkg: 50 },
    Kadabra: { types: ["Psychic"], bs: { hp: 40, at: 35, df: 30, sp: 105, sl: 120 }, weightkg: 50, nfe: true },
    Kakuna: { types: ["Bug", "Poison"], bs: { hp: 45, at: 45, df: 75, sp: 35, sl: 25 }, weightkg: 50, nfe: true },
    Kangaskhan: { types: ["Normal"], bs: { hp: 105, at: 95, df: 80, sp: 90, sl: 55 }, weightkg: 50 },
    Kingdra: { types: ["Water", "Dragon"], bs: { hp: 90, at: 95, df: 95, sp: 95, sl: 95 }, weightkg: 50 },
    Kingler: { types: ["Water", "Bug"], bs: { hp: 55, at: 130, df: 115, sp: 75, sl: 65 }, weightkg: 50 },
    Kleavor: { types: ["Bug", "Rock"], bs: { hp: 70, at: 135, df: 85, sp: 105, sl: 55 }, weightkg: 50 },
    Koffing: { types: ["Poison", "Fire"], bs: { hp: 40, at: 65, df: 95, sp: 35, sl: 60 }, weightkg: 50, nfe: true },
    Krabby: { types: ["Water", "Bug"], bs: { hp: 30, at: 105, df: 90, sp: 50, sl: 25 }, weightkg: 50, nfe: true },
    Lapras: { types: ["Ice", "Dragon"], bs: { hp: 120, at: 90, df: 80, sp: 60, sl: 95 }, weightkg: 50 },
    Leafeon: { types: ["Grass"], bs: { hp: 70, at: 95, df: 65, sp: 110, sl: 95 }, weightkg: 50 },
    Lickilicky: { types: ["Normal"], bs: { hp: 150, at: 100, df: 105, sp: 30, sl: 65 }, weightkg: 50 },
    Lickitung: { types: ["Normal"], bs: { hp: 130, at: 95, df: 95, sp: 30, sl: 60 }, weightkg: 50, nfe: true },
    Machamp: { types: ["Fighting"], bs: { hp: 95, at: 135, df: 80, sp: 55, sl: 75 }, weightkg: 50 },
    Machoke: { types: ["Fighting"], bs: { hp: 80, at: 100, df: 70, sp: 45, sl: 50 }, weightkg: 50, nfe: true },
    Machop: { types: ["Fighting"], bs: { hp: 70, at: 80, df: 50, sp: 35, sl: 35 }, weightkg: 50, nfe: true },
    Magikarp: { types: ["Water"], bs: { hp: 20, at: 25, df: 55, sp: 80, sl: 5 }, weightkg: 50, nfe: true },
    Magmar: { types: ["Fire", "Fighting"], bs: { hp: 65, at: 93, df: 55, sp: 97, sl: 105 }, weightkg: 50, nfe: true },
    Magmortar: { types: ["Fire", "Fighting"], bs: { hp: 75, at: 103, df: 75, sp: 77, sl: 115 }, weightkg: 50 },
    Magnemite: { types: ["Electric", "Steel"], bs: { hp: 25, at: 50, df: 70, sp: 40, sl: 85 }, weightkg: 50, nfe: true },
    Magneton: { types: ["Electric", "Steel"], bs: { hp: 60, at: 80, df: 100, sp: 80, sl: 110 }, weightkg: 50, nfe: true },
    Magnezone: { types: ["Electric", "Steel"], bs: { hp: 70, at: 90, df: 105, sp: 70, sl: 115 }, weightkg: 50 },
    Mankey: { types: ["Fighting"], bs: { hp: 40, at: 80, df: 35, sp: 70, sl: 35 }, weightkg: 50, nfe: true },
    Marowak: { types: ["Ground", "Ghost"], bs: { hp: 65, at: 150, df: 110, sp: 45, sl: 50 }, weightkg: 50 },
    Melmetal: { types: ["Steel"], bs: { hp: 135, at: 143, df: 108, sp: 34, sl: 80 }, weightkg: 50 },
    Meowth: { types: ["Normal", "Dark"], bs: { hp: 40, at: 55, df: 35, sp: 90, sl: 45 }, weightkg: 50, nfe: true },
    Metapod: { types: ["Bug"], bs: { hp: 50, at: 40, df: 80, sp: 30, sl: 25 }, weightkg: 50, nfe: true },
    Mew: { types: ["Psychic"], bs: { hp: 100, at: 100, df: 100, sp: 100, sl: 100 }, weightkg: 50 },
    Mewtwo: { types: ["Psychic"], bs: { hp: 90, at: 90, df: 70, sp: 126, sl: 154 }, weightkg: 50 },
    Moltres: { types: ["Fire", "Flying"], bs: { hp: 90, at: 100, df: 85, sp: 95, sl: 130 }, weightkg: 50 },
    'Mr. Mime': { types: ["Psychic", "Dark"], bs: { hp: 55, at: 70, df: 90, sp: 90, sl: 100 }, weightkg: 50, nfe: true },
    'Mr. Rime': { types: ["Psychic", "Ice"], bs: { hp: 75, at: 70, df: 100, sp: 85, sl: 120 }, weightkg: 50 },
    Muk: { types: ["Poison", "Dark"], bs: { hp: 105, at: 105, df: 75, sp: 50, sl: 85 }, weightkg: 50 },
    Nidoking: { types: ["Poison", "Ground"], bs: { hp: 81, at: 92, df: 77, sp: 85, sl: 95 }, weightkg: 50 },
    Nidoqueen: { types: ["Normal", "Ground"], bs: { hp: 95, at: 82, df: 87, sp: 76, sl: 90 }, weightkg: 50 },
    'Nidoran-F': { types: ["Normal"], bs: { hp: 55, at: 47, df: 52, sp: 41, sl: 40 }, weightkg: 50, nfe: true },
    'Nidoran-M': { types: ["Poison"], bs: { hp: 46, at: 57, df: 42, sp: 50, sl: 40 }, weightkg: 50, nfe: true },
    Nidorina: { types: ["Normal"], bs: { hp: 70, at: 62, df: 67, sp: 56, sl: 65 }, weightkg: 50, nfe: true },
    Nidorino: { types: ["Poison"], bs: { hp: 61, at: 72, df: 57, sp: 65, sl: 65 }, weightkg: 50, nfe: true },
    Ninetales: { types: ["Fire", "Psychic"], bs: { hp: 77, at: 65, df: 80, sp: 101, sl: 102 }, weightkg: 50 },
    Oddish: { types: ["Grass", "Poison"], bs: { hp: 50, at: 50, df: 55, sp: 30, sl: 80 }, weightkg: 50, nfe: true },
    Omanyte: { types: ["Water", "Rock"], bs: { hp: 35, at: 40, df: 100, sp: 35, sl: 90 }, weightkg: 50, nfe: true },
    Omastar: { types: ["Water", "Rock"], bs: { hp: 70, at: 60, df: 120, sp: 55, sl: 125 }, weightkg: 50 },
    Onix: { types: ["Rock", "Dragon"], bs: { hp: 55, at: 80, df: 145, sp: 70, sl: 35 }, weightkg: 50, nfe: true },
    Paras: { types: ["Bug", "Grass"], bs: { hp: 35, at: 70, df: 55, sp: 25, sl: 70 }, weightkg: 50, nfe: true },
    Parasect: { types: ["Bug", "Grass"], bs: { hp: 90, at: 105, df: 100, sp: 25, sl: 100 }, weightkg: 50 },
    Persian: { types: ["Normal", "Dark"], bs: { hp: 65, at: 95, df: 60, sp: 115, sl: 85 }, weightkg: 50 },
    Pidgeot: { types: ["Flying", "???"], bs: { hp: 88, at: 100, df: 75, sp: 106, sl: 70 }, weightkg: 50 },
    Pidgeotto: { types: ["Flying", "???"], bs: { hp: 70, at: 70, df: 60, sp: 72, sl: 53 }, weightkg: 50, nfe: true },
    Pidgey: { types: ["Flying", "???"], bs: { hp: 40, at: 50, df: 40, sp: 55, sl: 35 }, weightkg: 50, nfe: true },
    Pikachu: { types: ["Electric"], bs: { hp: 35, at: 75, df: 40, sp: 90, sl: 75 }, weightkg: 50, nfe: true },
    Pinsir: { types: ["Bug", "Fighting"], bs: { hp: 65, at: 125, df: 100, sp: 95, sl: 45 }, weightkg: 50 },
    Politoed: { types: ["Water", "Fairy"], bs: { hp: 100, at: 70, df: 95, sp: 65, sl: 100 }, weightkg: 50 },
    Poliwag: { types: ["Water"], bs: { hp: 40, at: 45, df: 40, sp: 90, sl: 45 }, weightkg: 50, nfe: true },
    Poliwhirl: { types: ["Water"], bs: { hp: 70, at: 65, df: 65, sp: 85, sl: 55 }, weightkg: 50, nfe: true },
    Poliwrath: { types: ["Water", "Fighting"], bs: { hp: 100, at: 90, df: 95, sp: 65, sl: 85 }, weightkg: 50 },
    Ponyta: { types: ["Fire"], bs: { hp: 50, at: 70, df: 55, sp: 90, sl: 70 }, weightkg: 50, nfe: true },
    Porygon: { types: ["Psychic", "Electric"], bs: { hp: 90, at: 50, df: 95, sp: 70, sl: 80 }, weightkg: 50, nfe: true },
    Porygon2: { types: ["Psychic", "Electric"], bs: { hp: 100, at: 50, df: 110, sp: 65, sl: 90 }, weightkg: 50, nfe: true },
    'Porygon-Z': { types: ["???"], bs: { hp: 85, at: 135, df: 45, sp: 135, sl: 50 }, weightkg: 50 },
    Primeape: { types: ["Fighting"], bs: { hp: 70, at: 120, df: 65, sp: 105, sl: 60 }, weightkg: 50, nfe: true },
    Psyduck: { types: ["Water"], bs: { hp: 60, at: 32, df: 48, sp: 55, sl: 70 }, weightkg: 50, nfe: true },
    Raichu: { types: ["Electric"], bs: { hp: 55, at: 90, df: 55, sp: 115, sl: 105 }, weightkg: 50, nfe: true },
    Rapidash: { types: ["Fire", "Normal"], bs: { hp: 65, at: 90, df: 70, sp: 120, sl: 95 }, weightkg: 50 },
    Raticate: { types: ["Normal"], bs: { hp: 60, at: 91, df: 60, sp: 117, sl: 70 }, weightkg: 50 },
    Rattata: { types: ["Normal"], bs: { hp: 30, at: 58, df: 35, sp: 72, sl: 25 }, weightkg: 50, nfe: true },
    Rhydon: { types: ["Rock", "Ground"], bs: { hp: 105, at: 130, df: 120, sp: 40, sl: 45 }, weightkg: 50, nfe: true },
    Rhyhorn: { types: ["Rock", "Ground"], bs: { hp: 80, at: 85, df: 95, sp: 25, sl: 30 }, weightkg: 50, nfe: true },
    Rhyperior: { types: ["Rock", "Ground"], bs: { hp: 110, at: 140, df: 130, sp: 30, sl: 50 }, weightkg: 50 },
    Sandshrew: { types: ["Ground"], bs: { hp: 50, at: 75, df: 85, sp: 40, sl: 30 }, weightkg: 50, nfe: true },
    Sandslash: { types: ["Ground"], bs: { hp: 80, at: 105, df: 115, sp: 65, sl: 55 }, weightkg: 50 },
    Scizor: { types: ["Bug", "Steel"], bs: { hp: 70, at: 130, df: 80, sp: 125, sl: 45 }, weightkg: 50 },
    Scyther: { types: ["Bug", "Flying"], bs: { hp: 60, at: 110, df: 80, sp: 115, sl: 55 }, weightkg: 50, nfe: true },
    Seadra: { types: ["Water", "Dragon"], bs: { hp: 80, at: 60, df: 95, sp: 95, sl: 90 }, weightkg: 50, nfe: true },
    Seaking: { types: ["Water", "Normal"], bs: { hp: 75, at: 107, df: 65, sp: 90, sl: 83 }, weightkg: 50 },
    Seel: { types: ["Water", "Ice"], bs: { hp: 65, at: 45, df: 55, sp: 45, sl: 70 }, weightkg: 50, nfe: true },
    Shellder: { types: ["Rock", "Ice"], bs: { hp: 30, at: 65, df: 105, sp: 40, sl: 40 }, weightkg: 50, nfe: true },
    'Sirfetch\u2019d': { types: ["Fighting", "Flying"], bs: { hp: 80, at: 110, df: 80, sp: 82, sl: 98 }, weightkg: 50 },
    Slowbro: { types: ["Psychic", "Rock"], bs: { hp: 95, at: 95, df: 115, sp: 25, sl: 90 }, weightkg: 50 },
    Slowking: { types: ["Psychic", "Water"], bs: { hp: 95, at: 95, df: 90, sp: 25, sl: 115 }, weightkg: 50 },
    Slowpoke: { types: ["Psychic"], bs: { hp: 90, at: 55, df: 65, sp: 15, sl: 50 }, weightkg: 50, nfe: true },
    Snorlax: { types: ["Normal"], bs: { hp: 160, at: 115, df: 60, sp: 30, sl: 65 }, weightkg: 50 },
    Spearow: { types: ["Flying", "Dark"], bs: { hp: 40, at: 55, df: 35, sp: 70, sl: 30 }, weightkg: 50, nfe: true },
    Squirtle: { types: ["Water"], bs: { hp: 44, at: 48, df: 65, sp: 43, sl: 53 }, weightkg: 50, nfe: true },
    Starmie: { types: ["Water", "Psychic"], bs: { hp: 55, at: 65, df: 80, sp: 115, sl: 105 }, weightkg: 50 },
    Staryu: { types: ["Water"], bs: { hp: 30, at: 45, df: 55, sp: 85, sl: 70 }, weightkg: 50, nfe: true },
    Steelix: { types: ["Steel", "Dragon"], bs: { hp: 100, at: 110, df: 150, sp: 30, sl: 60 }, weightkg: 50 },
    Sylveon: { types: ["Fairy"], bs: { hp: 110, at: 60, df: 65, sp: 70, sl: 130 }, weightkg: 50 },
    Tangela: { types: ["Grass"], bs: { hp: 65, at: 35, df: 115, sp: 95, sl: 100 }, weightkg: 50, nfe: true },
    Tangrowth: { types: ["Grass", "Water"], bs: { hp: 85, at: 55, df: 125, sp: 65, sl: 120 }, weightkg: 50 },
    Tauros: { types: ["Normal"], bs: { hp: 75, at: 100, df: 95, sp: 110, sl: 70 }, weightkg: 50 },
    Tentacool: { types: ["Poison", "Water"], bs: { hp: 40, at: 40, df: 35, sp: 70, sl: 100 }, weightkg: 50, nfe: true },
    Tentacruel: { types: ["Poison", "Water"], bs: { hp: 80, at: 65, df: 65, sp: 105, sl: 120 }, weightkg: 50 },
    Umbreon: { types: ["Dark"], bs: { hp: 70, at: 65, df: 130, sp: 60, sl: 110 }, weightkg: 50 },
    Vaporeon: { types: ["Water"], bs: { hp: 130, at: 60, df: 70, sp: 65, sl: 110 }, weightkg: 50 },
    Venomoth: { types: ["Bug", "Poison"], bs: { hp: 70, at: 99, df: 60, sp: 96, sl: 105 }, weightkg: 50 },
    Venonat: { types: ["Poison", "Bug"], bs: { hp: 60, at: 60, df: 50, sp: 50, sl: 40 }, weightkg: 50, nfe: true },
    Venusaur: { types: ["Grass"], bs: { hp: 85, at: 80, df: 90, sp: 80, sl: 105 }, weightkg: 50 },
    Victreebel: { types: ["Grass", "Poison"], bs: { hp: 80, at: 105, df: 65, sp: 80, sl: 100 }, weightkg: 50 },
    Vileplume: { types: ["Grass", "Poison"], bs: { hp: 90, at: 75, df: 95, sp: 50, sl: 120 }, weightkg: 50 },
    Voltorb: { types: ["Electric", "Normal"], bs: { hp: 40, at: 30, df: 50, sp: 100, sl: 55 }, weightkg: 50, nfe: true },
    Vulpix: { types: ["Fire"], bs: { hp: 40, at: 40, df: 44, sp: 61, sl: 65 }, weightkg: 50, nfe: true },
    Wartortle: { types: ["Water"], bs: { hp: 59, at: 63, df: 85, sp: 58, sl: 70 }, weightkg: 50, nfe: true },
    Weedle: { types: ["Bug", "Poison"], bs: { hp: 40, at: 40, df: 30, sp: 50, sl: 20 }, weightkg: 50, nfe: true },
    Weepinbell: { types: ["Grass", "Poison"], bs: { hp: 65, at: 90, df: 50, sp: 55, sl: 85 }, weightkg: 50, nfe: true },
    Weezing: { types: ["Poison", "Fire"], bs: { hp: 80, at: 90, df: 120, sp: 55, sl: 85 }, weightkg: 50 },
    Wigglytuff: { types: ["Fairy", "Psychic"], bs: { hp: 140, at: 70, df: 60, sp: 45, sl: 105 }, weightkg: 50 },
    Zapdos: { types: ["Electric", "Flying"], bs: { hp: 90, at: 95, df: 85, sp: 100, sl: 130 }, weightkg: 50 },
    Zubat: { types: ["Poison", "Flying"], bs: { hp: 40, at: 55, df: 35, sp: 60, sl: 40 }, weightkg: 50, nfe: true }
};
var GSC_PATCH = {
