...
var RBY = {
    ...
    Bide: { bp: 0, category: 'Status', type: 'Normal' },
    Bind: { bp: 20, type: 'Normal' },
    Bite: { bp: 65, type: 'Dark' },
    ...
    'Comet Punch': { bp: 30, type: 'Normal', multihit: [2, 5] },
    Constrict: { bp: 100, type: 'Normal' },
    Conversion: { bp: 0, category: 'Status', type: 'Normal' },
    Counter: { bp: 1, type: 'Fighting' },
    Crabhammer: { bp: 110, type: 'Water' },
    'Defense Curl': { bp: 0, category: 'Status', type: 'Normal' },
    Dig: { bp: 75, type: 'Ground' },
    Disable: { bp: 0, category: 'Status', type: 'Normal' },
    'Dizzy Punch': { bp: 95, type: 'Normal' },
    'Double-Edge': { bp: 110, type: 'Normal', recoil: [25, 100] },
    'Double Kick': { bp: 35, type: 'Fighting', multihit: 2 },
    'Double Slap': { bp: 20, type: 'Normal', multihit: [2, 5] },
    'Dragon Rage': { bp: 90, type: 'Dragon' },
    'Dream Eater': { bp: 130, type: 'Ghost', drain: [1, 2] },
    Earthquake: { bp: 100, type: 'Ground' },
    Explosion: { bp: 165, type: 'Normal' },
    'Fire Blast': { bp: 120, type: 'Fire' },
    'Fire Spin': { bp: 120, type: 'Fire' },
    Bulldoze: { bp: 85, type: 'Ground' },
    Fly: { bp: 0, category: 'Status', type: 'Flying' },
    'Focus Energy': { bp: 0, category: 'Status', type: 'Normal' },
    'Fury Attack': { bp: 50, type: 'Flying' },
    'Fury Swipes': { bp: 27, type: 'Normal', multihit: [2, 5] },
    ...
    'High Jump Kick': { bp: 120, type: 'Fighting', hasCrashDamage: true },
    'Drill Run': { bp: 110, type: 'Ground' },
    ...
    'Icy Wind': { bp: 50, type: 'Ice' },
    'Night Shade': { bp: 75, type: 'Ghost' },
    'Petal Dance': { bp: 110, type: 'Grass' },
    'Pin Missile': { bp: 25, type: 'Bug', multihit: [2, 5] },
    'Poison Sting': { bp: 25, type: 'Poison' },
    Psychic: { bp: 90, type: 'Psychic' },
    'Bug Buzz': { bp: 95, type: 'Bug' },
    Rage: { bp: 50, type: 'Normal' },
    'Razor Leaf': { bp: 55, type: 'Grass' },
    'Air Slash': { bp: 90, type: 'Flying' },
    ...
    'Self-Destruct': { bp: 140, type: 'Normal' },
    'Head Smash': { bp: 110, type: 'Rock', recoil: [1, 4] },
    Slash: { bp: 65, type: 'Normal' },
    Sludge: { bp: 95, type: 'Poison' },
    'Soft-Boiled': { bp: 0, category: 'Status', type: 'Normal' },
    'Solar Beam': { bp: 80, type: 'Grass' },
    'Spark': { bp: 50, type: 'Electric' },
    'Rock Blast': { bp: 25, type: 'Rock', multihit: [2, 5] },
    Stomp: { bp: 65, type: 'Normal' },
    Struggle: { bp: 50, type: '???', recoil: [1, 2] },
    'Stun Spore': { bp: 0, category: 'Status', type: 'Grass' },
    Submission: { bp: 110, type: 'Fighting', recoil: [1, 4] },
    Substitute: { bp: 0, category: 'Status', type: 'Normal' },
    'Super Fang': { bp: 1, type: 'Normal' },
    Swift: { bp: 65, type: 'Fire' },
    ...
    'Bone Club': { bp: 120, type: 'Ghost' },
    'Dark Pulse': { bp: 95, type: 'Dark' },
    'Hyper Fang': { bp: 105, type: 'Normal' },
    ...
    'Fire Punch': { bp: 100, type: 'Fire' },
    Harden: { bp: 0, category: 'Status', type: 'Normal' },
    'Iron Head': { bp: 60, type: 'Steel' },
    'Horn Attack': { bp: 65, type: 'Normal' },
    'Ice Punch': { bp: 100, type: 'Ice' },
    'Mega Kick': { bp: 115, type: 'Fighting' },
    'Drain Punch': { bp: 75, type: 'Fighting', drain: [1, 2] },
    'Moonblast': { bp: 95, type: 'Fairy' },
    'Pay Day': { bp: 55, type: 'Normal' },
    Peck: { bp: 45, type: 'Flying' },
    Pound: { bp: 45, type: 'Normal' },
    Psybeam: { bp: 75, type: 'Psychic' },
    'Quick Attack': { bp: 50, type: 'Normal', priority: 1 },
    Scratch: { bp: 45, type: 'Normal' },
    TMTrainer: { bp: 110, type: '???' },
    Slam: { bp: 100, type: 'Normal' },
    Smokescreen: { bp: 40, type: 'Fire' },
    Splash: { bp: 0, category: 'Status', type: 'Normal' },
    Strength: { bp: 75, type: 'Rock' },
    'Thunder Punch': { bp: 100, type: 'Electric' },
    'Thunder Shock': { bp: 45, type: 'Electric' },
    'Vise Grip': { bp: 70, type: 'Bug' },
    'Water Gun': { bp: 65, type: 'Water' },
